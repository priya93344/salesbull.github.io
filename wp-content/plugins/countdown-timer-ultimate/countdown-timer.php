...
if( ! defined( 'WPCDT_VERSION' ) ) {
	define( 'WPCDT_VERSION', '2.3.1' ); // Version of plugin
}
...
if( ! defined( 'WPCDT_PLUGIN_LINK_UPGRADE' ) ) {
	define('WPCDT_PLUGIN_LINK_UPGRADE','https://www.essentialplugin.com/pricing/?utm_source=WP&utm_medium=Countdown&utm_campaign=Upgrade-PRO#wpos-epb'); // Plugin Check link
}
