			...
			<tbody>
				...
				<tr class="wpcdt-pro-feature">
					...
					<td>
						...
						<strong><?php echo sprintf( __( 'Utilize this <a href="%s" target="_blank">Premium Features</a> to get best of this plugin with Annual or Lifetime bundle deal.', 'countdown-timer-ultimate'), WPCDT_PLUGIN_LINK_UNLOCK); ?></strong>
					</td>
				</tr>
				<tr>
					<th>
				...
				<tr class="wpcdt-pro-feature">
					<th colspan="2">
						...
						<?php echo sprintf( __( 'Utilize these <a href="%s" target="_blank">Premium Features</a> to get best of this plugin with Annual or Lifetime bundle deal.', 'countdown-timer-ultimate'), WPCDT_PLUGIN_LINK_UNLOCK); ?></div>
					</th>
				</tr>
				<tr class="wpcdt-pro-feature">
