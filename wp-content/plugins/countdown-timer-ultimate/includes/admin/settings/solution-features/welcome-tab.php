...
<div id="wpcdt_welcome_tabs" class="wpcdt-vtab-cnt wpcdt_welcome_tabs wpcdt-clearfix">	
	...
	<div class="wpcdt-sf-welcome-wrap" style="border: 1px solid #ddd; background: #fff;box-shadow: 0 3px 2px rgb(0 0 0 / 5%);padding: 50px; margin-bottom: 1rem;">
		<div class="wpcdt-sf-welcome-inr wpcdt-sf-center">
			<h5 class="wpcdt-sf-content" style="font-size:20px;">You can use it as CountDown for <span class="wpcdt-sf-blue">WebSites, Events and Product launch or as expiry date for Offers and Discounts</span>. The Plugin also works with <span class="wpcdt-sf-blue">WooCommerce and EDD coupons</span> and you can display coupons expiry date.
