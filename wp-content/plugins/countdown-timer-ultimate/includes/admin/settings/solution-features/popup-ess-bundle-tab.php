...
<div id="wpcdt_unlock_tabs" class="wpcdt-vtab-cnt wpcdt_unlock_tabs wpcdt-clearfix">
	...
	<div class="wpcpt-upgrade-image-wrap">
		<img src="<?php echo esc_url( WPCDT_URL ); ?>assets/images/image-upgrade.png" alt="image-upgrade" title="image-upgrade" />
	</div>
	...
	<div class="wpcdt-deal-offer-wrap">
		<div class="wpcdt-deal-offer"> 
			<div class="wpcdt-inn-deal-offer">
				...
				<h4 class="wpcdt-inn-deal-sub-hedding"><span style="color:red;">Extra Bonus: </span>Users will get <span>15% off</span> on the regular price using this coupon code.</h4>
			</div>
			<div class="wpcdt-inn-deal-offer-btn">
				<div class="wpcdt-inn-deal-code"><span>EPS15</span></div>
				<a href="<?php echo WPCDT_PLUGIN_BUNDLE_LINK; ?>" target="_blank" class="wpcdt-sf-btn wpcdt-sf-btn-orange"><span class="dashicons dashicons-cart"></span> Get Essential Bundle Now</a>
			</div>
		</div>
	</div>
