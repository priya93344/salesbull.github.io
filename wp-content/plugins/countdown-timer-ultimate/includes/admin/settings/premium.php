		...
		<div id="post-body" class="metabox-holder">
			<div id="post-body-content">
				...
				<div style="text-align: center; background: #DCDCDC; margin: 30px 0; padding: 10px 30px 30px 30px;">
					...
					<a href="<?php echo WPCDT_PLUGIN_LINK_UPGRADE; ?>" target="_blank" class="wpcdt-sf-btn wpcdt-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle Deal</a>
					...
					<a href="<?php echo WPCDT_PLUGIN_LINK_UPGRADE; ?>" target="_blank" class="wpcdt-sf-btn wpcdt-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
				</div>
				...
				<table class="wpos-plugin-pricing-table">
					...
					<colgroup></colgroup>	
						...
						<tr>
							...
							<th>
								...
								<a href="<?php echo WPCDT_PLUGIN_LINK_UPGRADE; ?>" class="wpos-button" target="_blank">Buy Now</a>
							</th>	    		
						</tr>
					</thead>
					...
					<tfoot>
						<tr>
							...
							<td>
							<h3 class="wpos-deal-heading">Choose best pricing in <span class="h-blue"> Annual</span> or <span class="h-blue">Lifetime</span> deal</h3>
							<a href="<?php echo WPCDT_PLUGIN_LINK_UPGRADE; ?>" class="wpos-button" target="_blank">Buy Now</a></td>
						</tr>
					</tfoot>
